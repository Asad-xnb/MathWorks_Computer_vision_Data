function [MOVINGREG] = registerMarsRoverImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 15-Jul-2025
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',665.625000,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',665.625000,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',8.750000,'MaxRatio',0.087500);
